...
class DSPMValidator:
 ...
 # Try this simplified version first to test if JSON parsing works:
        ...
        prompt = (
            ...
            "Cloud Scan Data (Client Results):\n" + client_result_content + "\n"  
            ...
            "- Create entity-level breakdown comparing Test Data Count, Cloud Scan Count, Matched, Missed, Extra for each entity type.\n"
